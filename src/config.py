...
START_POSE = [1.75, 3.17, 0.0]

# スタート位置のランダム化（Trueの場合、下記リストからランダムに選択）
START_POSE_RANDOMIZE = True
START_POSES = [
    [1.75, 3.17, 0.0],     # コース中央 (壁まで 2.75 m)
    [8.95, 2.92, 0.0],     # コース中央 (壁まで 2.67 m)
    [14.05, -3.28, 0.0],   # コース内 (壁まで 2.41 m)
    [-3.00, 1.22, 0.0],    # 前回の安全候補 (壁まで 0.82 m)
    [11.75, -3.93, 0.0],   # 前回の安全候補 (壁まで 1.20 m)
]

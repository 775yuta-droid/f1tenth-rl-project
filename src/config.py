...
MIN_SPEED = float(os.environ.get("MIN_SPEED", "0.3"))  # EXP-33: env varでカリキュラム学習の各フェーズを制御可能
MAX_SPEED = float(os.environ.get("MAX_SPEED", "2.0"))  # EXP-33: env varでカリキュラム学習の各フェーズを制御可能
...
# --- 報酬設計の設定 ---
REWARD_COLLISION = -50.0   # EXP-33b: -200.0 -> -50.0 (衝突の重みを下げ、生き延びることで取り返せるスケールに調整)
